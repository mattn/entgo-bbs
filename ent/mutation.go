...
// EntryMutation represents an operation that mutate the Entries
// nodes in the graph.
...
// entryOption allows to manage the mutation configuration using functional options.
type entryOption func(*EntryMutation)

// newEntryMutation creates new mutation for $n.Name.
...
// OldContent returns the old content value of the Entry.
// If the Entry object wasn't provided to the builder, the object is fetched
// from the database.
...
// OldCreatedAt returns the old created_at value of the Entry.
// If the Entry object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
